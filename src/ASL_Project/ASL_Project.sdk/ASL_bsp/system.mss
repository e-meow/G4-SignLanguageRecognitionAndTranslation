...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ACCEL
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ACCEL_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ADC
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ADC_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ASL
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ASL_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = HEX
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = HEX_0
END
