...
################################################################
# This is a generated script based on design: ASL
#
...
proc write_mig_file_ASL_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {    <ModuleName>ASL_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_ASL_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set JB [ create_bd_port -dir I -from 3 -to 0 JB ]
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_ALL_OUTPUTS {0} CONFIG.C_GPIO_WIDTH {7} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_0
  ...
  set_property -dict [ list CONFIG.C_DEFAULT_TFT_BASE_ADDR {0x84000000} CONFIG.C_EN_I2C_INTF {0} CONFIG.C_MAX_BURST_LEN {256} CONFIG.C_M_AXI_DATA_WIDTH {32} CONFIG.C_TFT_INTERFACE {0}  ] $axi_tft_0
  ...
  set_property -dict [ list CONFIG.CLKOUT2_JITTER {114.829} CONFIG.CLKOUT2_PHASE_ERROR {98.575} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {200.000} CONFIG.CLKOUT2_USED {true} CONFIG.CLKOUT3_JITTER {175.402} CONFIG.CLKOUT3_PHASE_ERROR {98.575} CONFIG.CLKOUT3_USED {true} CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} CONFIG.MMCM_CLKIN1_PERIOD {10.0} CONFIG.MMCM_CLKOUT1_DIVIDE {5} CONFIG.MMCM_CLKOUT2_DIVIDE {40} CONFIG.MMCM_DIVCLK_DIVIDE {1} CONFIG.NUM_OUT_CLKS {3} CONFIG.PRIM_SOURCE {Single_ended_clock_capable_pin} CONFIG.RESET_BOARD_INTERFACE {reset} CONFIG.RESET_PORT {resetn} CONFIG.RESET_TYPE {ACTIVE_LOW} CONFIG.USE_BOARD_FLOW {true}  ] $clk_wiz_1
  ...
  write_mig_file_ASL_mig_7series_0_0 $str_mig_file_path
  ...
  set_property -dict [ list CONFIG.DIN_FROM {5} CONFIG.DIN_TO {2} CONFIG.DIN_WIDTH {6} CONFIG.DOUT_WIDTH {4}  ] $xlslice_0

  # Create instance: xlslice_1, and set properties
  set xlslice_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_1 ]
  set_property -dict [ list CONFIG.DIN_FROM {5} CONFIG.DIN_TO {2} CONFIG.DIN_WIDTH {6} CONFIG.DOUT_WIDTH {4}  ] $xlslice_1

  # Create instance: xlslice_2, and set properties
  set xlslice_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_2 ]
  set_property -dict [ list CONFIG.DIN_FROM {5} CONFIG.DIN_TO {2} CONFIG.DIN_WIDTH {6} CONFIG.DOUT_WIDTH {4}  ] $xlslice_2

  # Create interface connections
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_tft_0/M_AXI_MM] [get_bd_intf_pins microblaze_0_axi_periph/S01_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins ADC_0/ADC_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins HEX_0/HEX_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins ASL_0/ASL_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins ACCEL_0/ACCEL_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  ...
  # Create port connections
  connect_bd_net -net ACCEL_0_MOSI [get_bd_ports MOSI] [get_bd_pins ACCEL_0/MOSI]
  connect_bd_net -net ACCEL_0_SCLK [get_bd_ports SCLK] [get_bd_pins ACCEL_0/SCLK]
  connect_bd_net -net ACCEL_0_SS [get_bd_ports SS] [get_bd_pins ACCEL_0/SS]
  connect_bd_net -net ADC_0_LED [get_bd_ports LED] [get_bd_pins ADC_0/LED]
  connect_bd_net -net HEX_0_an [get_bd_ports an] [get_bd_pins HEX_0/an]
  connect_bd_net -net HEX_0_dp [get_bd_ports dp] [get_bd_pins HEX_0/dp]
  connect_bd_net -net HEX_0_seg [get_bd_ports seg] [get_bd_pins HEX_0/seg]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn]
  connect_bd_net -net MISO_1 [get_bd_ports MISO] [get_bd_pins ACCEL_0/MISO]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins ACCEL_0/accel_axi_aresetn] [get_bd_pins ADC_0/adc_axi_aresetn] [get_bd_pins ASL_0/asl_axi_aresetn] [get_bd_pins HEX_0/hex_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_tft_0/m_axi_aresetn] [get_bd_pins axi_tft_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  connect_bd_net -net axi_tft_0_tft_hsync [get_bd_ports tft_hsync] [get_bd_pins axi_tft_0/tft_hsync]
  connect_bd_net -net axi_tft_0_tft_vga_b [get_bd_pins axi_tft_0/tft_vga_b] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net axi_tft_0_tft_vga_g [get_bd_pins axi_tft_0/tft_vga_g] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins ACCEL_0/accel_axi_aclk] [get_bd_pins ADC_0/adc_axi_aclk] [get_bd_pins ASL_0/asl_axi_aclk] [get_bd_pins HEX_0/hex_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_tft_0/m_axi_aclk] [get_bd_pins axi_tft_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net gpio_io_i_2 [get_bd_ports JB] [get_bd_pins axi_gpio_1/gpio_io_i]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk]
  ...
  connect_bd_net -net vauxn11_1 [get_bd_ports vauxn11] [get_bd_pins ADC_0/vauxn11]
  connect_bd_net -net vauxp11_1 [get_bd_ports vauxp11] [get_bd_pins ADC_0/vauxp11]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports tft_vga_g] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports tft_vga_b] [get_bd_pins xlslice_1/Dout]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x44A40000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs ACCEL_0/ACCEL_AXI/ACCEL_AXI_reg] SEG_ACCEL_0_ACCEL_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs ADC_0/ADC_AXI/ADC_AXI_reg] SEG_ADC_0_ADC_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x44A30000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs ASL_0/ASL_AXI/ASL_AXI_reg] SEG_ASL_0_ASL_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs HEX_0/HEX_AXI/HEX_AXI_reg] SEG_HEX_0_HEX_AXI_reg
  ...
  create_bd_addr_seg -range 0x200000 -offset 0x44C00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_tft_0/S_AXI_MM/Reg] SEG_axi_tft_0_Reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x44A40000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs ACCEL_0/ACCEL_AXI/ACCEL_AXI_reg] SEG_ACCEL_0_ACCEL_AXI_reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_ACCEL_0_ACCEL_AXI_reg]

  create_bd_addr_seg -range 0x10000 -offset 0x44A10000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs ADC_0/ADC_AXI/ADC_AXI_reg] SEG_ADC_0_ADC_AXI_reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_ADC_0_ADC_AXI_reg]

  create_bd_addr_seg -range 0x10000 -offset 0x44A30000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs ASL_0/ASL_AXI/ASL_AXI_reg] SEG_ASL_0_ASL_AXI_reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_ASL_0_ASL_AXI_reg]

  create_bd_addr_seg -range 0x10000 -offset 0x44A20000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs HEX_0/HEX_AXI/HEX_AXI_reg] SEG_HEX_0_HEX_AXI_reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_HEX_0_HEX_AXI_reg]

  create_bd_addr_seg -range 0x10000 -offset 0x40000000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_axi_gpio_0_Reg]

  create_bd_addr_seg -range 0x10000 -offset 0x44A00000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs axi_tft_0/S_AXI_MM/Reg] SEG_axi_tft_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs axi_tft_0/Video_data/SEG_axi_tft_0_Reg]

  create_bd_addr_seg -range 0x10000 -offset 0x40600000 [get_bd_addr_spaces axi_tft_0/Video_data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
